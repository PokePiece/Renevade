            ...
            {showVoidOverlay && (
                <div className="fixed left-[25px] top-5 w-[calc(100%-50px)] bottom-[25px] bg-white/98 text-white font-light text-md box-border flex flex-col">
                    <div className='w-full h-full'>
                        <h1 className='text-2xl flex flex-center text-center justify-center my-3 text-black'>Void Manager</h1>
                        <div className='text-lg text-gray-700 flex justify-center mb-3'>
                            Manage the Void directly.
                        </div>
                            <Chat 
